...
def generate_launch_description():
    ...
    rviz_config_path = os.path.join(pkg_survey_path, 'rviz/config_kobuki_tb2_slam.rviz')
    ...
    slam_toolbox_params_path = os.path.join(pkg_survey_path, 'params', 'slam_toolbox_kobuki_tb2.yaml')
    ...
    tf2_base_link_laser = Node(package = "tf2_ros",
                               executable = "static_transform_publisher",
                               arguments = ["0", "0", "0.45", "0", "3.14", "0", "base_link", "laser"],
                               output = "screen")
    
    # tf2_base_link_camera_cmd = Node(package = "tf2_ros",
    #                                 executable = "static_transform_publisher",
    #                                 arguments = ["0.1", "0", "0.22", "0", "0", "0", "1", "base_link", "camera_link"],
    #                                 output = "screen")
    
    tf2_base_link_fake_camera_cmd = Node(package = "tf2_ros",
                                     executable = "static_transform_publisher",
                                     arguments = ["0.1", "0", "0.22", "0", "0", "0", "1", "base_link", "fake_camera"],
                                     output = "screen")
    ...
    ld.add_action(tf2_base_link_laser)
